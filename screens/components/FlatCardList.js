  ...
  render() {    
    return (
      <TouchableWithoutFeedback onPress={ () => this.props.onPress(this.props.data, this.card)}>
        <View ref={(viewRef) => this.card = viewRef} style = {{height : 250,  marginBottom : 15, shadowOpacity : 0.4, shadowOffset : {width : 1, height : 1}, elevation : 6, backgroundColor: 'black', borderRadius:15}}>
          <View >
            <View>
              <FastImage
                style={{height: 250, width: '100%', flex: 1, position :'absolute',  borderRadius:15}}
                source={{
              ...
              <View style={{
                ...
                <View style={{margin:20, flex : 10}}>
                  ...
                  <Text 
                    style={{color : 'white', marginRight : 10, marginTop : 10, fontSize : 25, fontWeight : '600'}}>
                    {this.props.title}
                  </Text>
                </View>
